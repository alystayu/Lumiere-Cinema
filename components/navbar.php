...
.navbar {
    ...
    z-index: 1000;
    /* Membuat navbar tetap di atas elemen lain */
}
</style>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="crud_film.php" class="nav-link">Home</a></li>
                        <li class="nav-item"><a href="crud_film.php" class="nav-link">Film</a></li>
                        <li class="nav-item"><a href="riwayat_transaksi.php" class="nav-link">Riwayat Transaksi</a></li>
                        <li class="nav-item"><a href="login.php" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
