...
<style>
    eate this bootstrap snippet, You can copy and paste the following css code inside a page with bootstrap 4.3.1 included, to get the result that you can see in the preview selection
...
.masthead {
    ...
    background-image: url(https://startbootstrap.com/assets/img/overlay.svg), linear-gradient(45deg, #1c2938 0%, #1c2938 100%);
